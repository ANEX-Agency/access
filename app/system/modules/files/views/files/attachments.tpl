...
<div class="uk-grid">
	...
	<div class="uk-width-1-1 uk-width-medium-2-3">
        ...
        {pagination pager=$pagination}{assemble route=project_files project_id=$active_project->getId() page='-PAGE-' category_id=$active_category->getId() show_attachments=true}{/pagination}
        {else}
        {pagination pager=$pagination}{assemble route=project_files project_id=$active_project->getId() page='-PAGE-' show_attachments=true}{/pagination}
        {/if}
        </div>
        {/if}
        <!-- PAGINATION END -->
