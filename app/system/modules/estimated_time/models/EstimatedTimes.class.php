<?php
  ...
  /**
   * EstimatedTimes class
   */
  class EstimatedTimes extends DataManager {
    ...
    function find($arguments = null) {
      return DataManager::find($arguments, TABLE_PREFIX . 'estimated_times', 'EstimatedTime');
    } // find
    ...
    function findBySQL($sql, $arguments = null, $one = false) {
      return DataManager::findBySQL($sql, $arguments, $one, TABLE_PREFIX . 'estimated_times', 'EstimatedTime');
    } // findBySQL
    ...
    function findById($id) {
      return DataManager::findById($id, TABLE_PREFIX . 'estimated_times', 'EstimatedTime');
    } // findById
    ...
    function count($conditions = null) {
      return DataManager::count($conditions, TABLE_PREFIX . 'estimated_times');
    } // count
    ...
    function update($updates, $conditions = null) {
      return DataManager::update($updates, $conditions, TABLE_PREFIX . 'estimated_times');
    } // update
    ...
    function delete($conditions = null) {
      return DataManager::delete($conditions, TABLE_PREFIX . 'estimated_times');
    } // delete
    ...
    function paginate($arguments = null, $page = 1, $per_page = 10) {
      return DataManager::paginate($arguments, $page, $per_page, TABLE_PREFIX . 'estimated_times', 'EstimatedTime');
    } // paginate
